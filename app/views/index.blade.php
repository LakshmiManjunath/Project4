...
@endif
		...
		<div id="app-name">
			<img src="../images/dottedl.png" alt="dotted_left"><span class="app-name" style="font-size:40px;font-weight:bold;padding-left:20px;padding-right:20px;">DAY BOOK</span><img src="../images/dottedr.png" alt="dotted_right">
		</div>
		<div class="infograph">
			<ul>
				<li>
					<ul>
						<li><img src="../images/how-to-use.png" alt="how-to-use"></li>
				...
				<li>
					<ul>
						<li><img src="../images/features.png" alt="features"></li>
				...
				<li>
					<ul>
						<li><img src="../images/editor.png" alt="Editor"></li>
				...
				<li>
					<ul>
						<li><img src="../images/implementation.png" alt="implementation"></li>
